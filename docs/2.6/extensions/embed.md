...
If you need to wrap the HTML in a container tag, consider using the [`HtmlDecorator` renderer](/2.6/customization/rendering/#wrapping-elements-with-htmldecorator):
