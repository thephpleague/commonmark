...
Otherwise, if you're using `MarkdownConverter` to customize the extensions in your parser, pass the configuration into the [Environment](/2.4/customization/environment/)'s constructor instead:
...
- `slug_normalizer` - Array of options for configuring how URL-safe slugs are created; see [the slug normalizer docs](/2.4/customization/slug-normalizer/#configuration) for more details
...
Additional configuration options are available for most of the [available extensions](/2.4/customization/extensions/) - refer to their individual documentation for more details.  For example, the CommonMark core extension offers these additional options:
...
[Learn more about customizing the Environment](/2.4/customization/environment/)
