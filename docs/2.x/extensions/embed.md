...
redirect_from:
  - /extensions/embed/
  - /2.5/extensions/embed/
  - /2.6/extensions/embed/
  - /2.7/extensions/embed/
---
...
If you need to wrap the HTML in a container tag, consider using the [`HtmlDecorator` renderer](/2.x/customization/rendering/#wrapping-elements-with-htmldecorator):
