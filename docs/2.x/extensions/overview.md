...
You can enable extensions by simply calling `->addExtension()` on the [Environment](/2.x/customization/environment/).
...
Or maybe you only want a subset of GFM extensions, plus the [Smart Punctuation extension](/2.x/extensions/smart-punctuation/):
...
See the [Custom Extensions](/2.x/customization/extensions/) page for details on how you can create your own custom extensions.

[Attributes]: /2.x/extensions/attributes/
[Autolinks]: /2.x/extensions/autolinks/
[Default Attributes]: /2.x/extensions/default-attributes/
[Description Lists]: /2.x/extensions/description-lists/
[Disallowed Raw HTML]: /2.x/extensions/disallowed-raw-html/
[Embed]: /2.x/extensions/embed/
[External Links]: /2.x/extensions/external-links/
...
[Task Lists]: /2.x/extensions/task-lists/
