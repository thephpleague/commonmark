...
redirect_from:
  - /extensions/heading-permalinks/
  - /2.0/extensions/heading-permalinks/
  - /2.1/extensions/heading-permalinks/
  - /2.2/extensions/heading-permalinks/
  - /2.3/extensions/heading-permalinks/
  - /2.4/extensions/heading-permalinks/
  - /2.5/extensions/heading-permalinks/
  - /2.6/extensions/heading-permalinks/
  - /2.7/extensions/heading-permalinks/
---
...
**Tip:** You can combine this with the [Table of Contents extension](/2.x/extensions/table-of-contents/) to automatically generate a list of links to the headings in your documents.
