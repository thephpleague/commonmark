...
redirect_from:
  - /extensions/inlines-only/
  - /2.0/extensions/inlines-only/
  - /2.1/extensions/inlines-only/
  - /2.2/extensions/inlines-only/
  - /2.3/extensions/inlines-only/
  - /2.4/extensions/inlines-only/
  - /2.5/extensions/inlines-only/
  - /2.6/extensions/inlines-only/
  - /2.7/extensions/inlines-only/
---
...
Although you normally add extra extensions along with [the default CommonMark Core extension](/2.x/extensions/commonmark/), we're not going to do that here, because this is essentially a slimmed-down version of the core extension:
