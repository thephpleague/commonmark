...
redirect_from:
  - /extensions/external-links/
  - /2.0/extensions/external-links/
  - /2.1/extensions/external-links/
  - /2.2/extensions/external-links/
  - /2.3/extensions/external-links/
  - /2.4/extensions/external-links/
  - /2.5/extensions/external-links/
  - /2.6/extensions/external-links/
  - /2.7/extensions/external-links/
---
...
When an external link is detected, the `ExternalLinkProcessor` will set the `external` data option on the `Link` node to either `true` or `false`.  You can therefore create a [custom link renderer](/2.x/customization/rendering/) which checks this value and behaves accordingly:
