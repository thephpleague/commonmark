...
redirect_from:
  ...
  - /2.0/extensions/commonmark/
  - /2.1/extensions/commonmark/
  - /2.2/extensions/commonmark/
  - /2.3/extensions/commonmark/
  - /2.4/extensions/commonmark/
  - /2.5/extensions/commonmark/
  - /2.6/extensions/commonmark/
  - /2.7/extensions/commonmark/
---
...
Alternatively, if you don't want all of the core Markdown syntax, avoid using `CommonMarkCoreExtension`.  You can always add just the individual parsers, renderers, etc. you actually want with the [`Environment`](/2.x/customization/environment/).  (This is actually how the [Inlines Only Extension](/2.x/extensions/inlines-only/) works - it only includes a subset of things that `CommonMarkCoreExtension` does!)
