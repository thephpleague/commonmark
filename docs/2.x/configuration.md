...
Otherwise, if you're using `MarkdownConverter` to customize the extensions in your parser, pass the configuration into the [Environment](/2.x/customization/environment/)'s constructor instead:
...
[Learn more about customizing the Environment](/2.x/customization/environment/)
