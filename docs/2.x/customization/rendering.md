...
redirect_from:
  ...
  - /2.0/customization/rendering/
  - /2.1/customization/rendering/
  - /2.2/customization/rendering/
  - /2.3/customization/rendering/
  - /2.4/customization/rendering/
...
The [XML renderer](/2.x/xml/) will automatically attempt to convert any AST nodes to XML by inspecting the name of the block/inline node and its attributes. You can instead control the XML element name and attributes by making your renderer implement `XmlNodeRendererInterface`:
