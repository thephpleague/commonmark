...
redirect_from:
  - /customization/abstract-syntax-tree/
  - /2.0/customization/abstract-syntax-tree/
  - /2.1/customization/abstract-syntax-tree/
  - /2.2/customization/abstract-syntax-tree/
  - /2.3/customization/abstract-syntax-tree/
  - /2.4/customization/abstract-syntax-tree/
  - /2.5/customization/abstract-syntax-tree/
  - /2.6/customization/abstract-syntax-tree/
  - /2.7/customization/abstract-syntax-tree/
---
...
- By calling the `getDocument()` method on either the `DocumentPreParsedEvent` or `DocumentParsedEvent` [see the (Event Dispatcher documentation](/2.x/customization/event-dispatcher/))

## Visualization

Even with an interactive debugger it can be tricky to view an entire tree at once.  Consider using the [`XmlRenderer`](/2.x/xml/) to provide a simple text-based representation of the AST for debugging purposes.
...
The best way to access and manipulate the AST is by adding an [event listener](/2.x/customization/event-dispatcher/) for the `DocumentParsedEvent`.
