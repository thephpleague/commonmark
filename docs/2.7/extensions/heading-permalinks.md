...
**Tip:** You can combine this with the [Table of Contents extension](/2.7/extensions/table-of-contents/) to automatically generate a list of links to the headings in your documents.
