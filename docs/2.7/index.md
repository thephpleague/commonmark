...
[![Software License](https://img.shields.io/badge/License-BSD--3-brightgreen.svg?style=flat-square)](https://github.com/thephpleague/commonmark/blob/HEAD/LICENSE)
...
**Important:** See the [basic usage](/2.7/basic-usage/) and [security](/2.7/security/) sections for important details.
