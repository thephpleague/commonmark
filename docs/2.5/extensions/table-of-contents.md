...
The [Heading Permalink](/2.5/extensions/heading-permalinks/) extension must also be included for this to work.
...
If you'd like to customize this further, you can implement a [custom event listener](/2.5/customization/event-dispatcher/#registering-listeners) to locate the `TableOfContents` node and reposition it somewhere else in the document prior to rendering.
