...
**Important:** See the [security](/2.5/security/) section for important details on avoiding security misconfigurations.
...
The `CommonMarkConverter` and `GithubFlavoredMarkdownConverter` shown above automatically configure [the environment](/2.5/customization/environment/) for you, but if you want to use [additional extensions](/2.5/customization/extensions/) you'll need to avoid those classes and use the generic `MarkdownConverter` class instead to customize [the environment](/2.5/customization/environment/) with whatever extensions you wish to use:
...
See the [configuration section](/2.5/configuration/) for more information on the available configuration options.
