...
redirect_from: /1.6/customization/event-dispatcher/
---
...
This event is dispatched once all other processing is done.  This offers extensions the opportunity to inspect and modify the [Abstract Syntax Tree](/1.x/customization/abstract-syntax-tree/) prior to rendering.
