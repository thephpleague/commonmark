...
redirect_from: /1.6/customization/environment/
---
...
Merges the given [configuration](/1.x/configuration/) settings into any existing ones.
...
Registers the given [extension](/1.x/customization/extensions/) with the environment.  This is typically how you'd integrate third-party extensions with this library.
...
See [Block Parsing](/1.x/customization/block-parsing/) for details.
...
See [Block Rendering](/1.x/customization/block-rendering/) for details.
...
See [Inline Parsing](/1.x/customization/inline-parsing/) for details.
...
See [Inline Rendering](/1.x/customization/inline-rendering/) for details.
...
See [Inline Parsing](/1.x/customization/delimiter-processing/) for details.
...
See [Event Dispatcher](/1.x/customization/event-dispatcher/) for details.
