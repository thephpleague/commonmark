...
redirect_from: /1.6/extensions/autolinks/
---

# Autolink Extension

_(Note: this extension is included by default within [the GFM extension](/1.x/extensions/github-flavored-markdown/))_
...
As of v1.5, [mention autolinking is now handled by a separate Mention extension](/1.x/extensions/mentions/).
