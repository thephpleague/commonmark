...
final class CallbackLinkGeneratorTest extends TestCase
{
    ...
    {
        $generator = new CallbackLinkGenerator(static function (string $handle, string &$label, string $symbol): ?string {
    ...
    public function testWithInvalidReturn(): void
    {
        ...
        $generator = new CallbackLinkGenerator(static function () {
